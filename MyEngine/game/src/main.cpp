...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("E:/GitHub/Game_Engine_3D/MyEngine/game/shaders/vert.spv");
        auto fragShaderCode = readFile("E:/GitHub/Game_Engine_3D/MyEngine/game/shaders/frag.spv");
